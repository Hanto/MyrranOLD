...
public class BarraTerrenos extends Group
{
    ...
    {
        BarraTerrenos barra = Mundo.getMundo().getBarraTerrenos();
        ...
        if (Mundo.player.getSpellSeleccionado() == SpellsData.TERRAFORMAR_ID)
        {
            ...
            {
                barra.clearActions();
                if (barra.getStage() == null)
                {
                    barra.setX(-MiscData.TILESIZE*2*numColumnas);
                    Mundo.player.getStageUI().addActor(barra);
                }
               barra.addAction(Actions.moveTo(5, barra.getY(), 0.5f, Interpolation.sine));
        ...
        else
        {
            ...
            {
                barra.clearActions();
                barra.addAction(Actions.sequence(Actions.moveTo(-MiscData.TILESIZE * 2 * numColumnas, barra.getY(), 0.5f, Interpolation.sine), Actions.removeActor()));
